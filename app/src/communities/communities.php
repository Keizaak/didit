...
<body>
    <div style="overflow-y: scroll; margin-top: 45px;">
        ...
        foreach ($values['communities'] as &$value) {
            ...
            echo "<td><a style='text-decoration : None;' href=../challenges/challenges.php?community=".$value['title']."><div style='font-weight: bold; margin-top: 20px; margin-bottom: 40px;'>".$value['title']."</div style='font-size: 12px;'><div style='margin-bottom: 20px;'>".$value['description']."</div></a></td>";
            echo "</tr></table></div>";
        }
        ?>
    </div>
