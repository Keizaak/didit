...
<body>
    <div style="overflow-y: scroll; margin-top: 45px;">
        ...
        foreach ($values['communities'] as &$value) {
            ...
            echo "<tdheight: 300px; width: 300px;><img style='border-radius: 50% !important; height: 250px !important; width: 250px !important;' class='img rounded custom-title-didit' src='".$value['image_url']."'></td>";
